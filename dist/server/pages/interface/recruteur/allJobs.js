...
function allJobs(info) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (info.query.dest === "unfilled") {
      setFilledJobs([]);
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('https://blooming-crag-03737.herokuapp.com/getUnFillededJob', {
      ...
      setUnfilledJobs([]);
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('https://blooming-crag-03737.herokuapp.com/getFillededJob', {
        company_id: info.query.company_id
      }).then(resutlt => {
        if (!resutlt.data.err) {
