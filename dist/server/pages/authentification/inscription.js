...
function inscription({
  ...
  const inscription = e => {
    ...
    if (user_password1 !== user_password2) {
      ...
      external_axios_default().post('https://blooming-crag-03737.herokuapp.com/signup', {
        user_name: user_name,
        ...
        if (!result.data.err) {
          ...
          if (router.query.dest === "recruteur") {
            external_axios_default().post('https://blooming-crag-03737.herokuapp.com/createCompany', {
          ...
          external_axios_default().post('https://blooming-crag-03737.herokuapp.com/createUserInfo', {
            //creer une centreprise à son nom
            user_id: result.data.user_info.user_id
          });
