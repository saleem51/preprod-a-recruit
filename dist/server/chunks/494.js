...
function recrutor() {
  ...
  (0,external_react_.useEffect)(() => {
    ...
    external_axios_default().post("https://blooming-crag-03737.herokuapp.com/getCompanyInfo", {
      user_id: loded_user.user_id
    }).then(reponse => {
      setCompanyInfo(reponse.data);

      if (reponse.data.company_id) {
        external_axios_default().post("https://blooming-crag-03737.herokuapp.com/getUnFillededJobLimit4", {
          company_id: reponse.data.company_id
        }).then(reponse => {
          setCompanyUnfillededJobs(reponse.data);
        });
        external_axios_default().post("https://blooming-crag-03737.herokuapp.com/getFillededJobLimit4", {
          company_id: reponse.data.company_id
        }).then(reponse => {
          setCompanyFilledeJobs(reponse.data);
        });
        external_axios_default().post("https://blooming-crag-03737.herokuapp.com/getConsultantByDepartment", {
  ...
  (0,external_react_.useEffect)(() => {
    external_axios_default().post("https://blooming-crag-03737.herokuapp.com/getConsultantCalendly", {
  ...
  const finalization = e => {
    ...
    if (true) {
      external_axios_default().post('https://blooming-crag-03737.herokuapp.com/updateCompanyInfo', {
  ...
  const newJobPosting = e => {
    ...
    if (!job_title || !job_contract_type || !job_country || !job_department || !job_required_grad || !job_required_level || !job_required_experience || !job_presentation_pdf || !job_presentation_video || !job_city || !job_zip_code || !job_origin || !job_statut) {
      ...
      external_axios_default().post('https://blooming-crag-03737.herokuapp.com/createJob', {
        job_title: job_title,
